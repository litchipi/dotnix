...
in
  {
    options.services.gitlab-runner = {
      secrets = lib.mkOption {
        ...
        description = "Secrets to use for the gitlab runner configuration";
      };
      ...
      services.gitlab-runner = {
        ...
        services = (builtins.mapAttrs (_:
          ...
          registrationConfigFile =
            config.secrets.secret_files.gitlab_runner_registrationConfigFile;
          environmentVariables = runnerEnvs;
        } runnerOpts) cfg.runner-images) // (if cfg.add_nix_service then
        { nix = {
          registrationConfigFile = config.secrets.secret_files."gitlab/runner_registrationConfigFile".file;
          dockerImage = "alpine";
          dockerVolumes = [
